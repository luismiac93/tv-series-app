...
//
//     final detailsSerieResponse = detailsSerieResponseFromJson(jsonString);

import 'dart:convert';

DetailsSerieResponse detailsSerieResponseFromJson(String str) => DetailsSerieResponse.fromJson(json.decode(str));

String detailsSerieResponseToJson(DetailsSerieResponse data) => json.encode(data.toJson());

class DetailsSerieResponse {
    DetailsSerieResponse({
        this.backdropPath,
        this.createdBy,
        this.episodeRunTime,
        this.firstAirDate,
    ...
    factory DetailsSerieResponse.fromJson(Map<String, dynamic> json) => DetailsSerieResponse(
